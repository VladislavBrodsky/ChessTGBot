      ...
      <AnimatePresence mode="wait">
        {notification && (
          <motion.div
            ...
            className="w-full max-w-[340px] bg-[var(--bg-elevated)] border border-[var(--border-muted)] rounded-2xl py-2.5 px-3.5 flex items-center gap-3 shadow-[var(--shadow-premium)] pointer-events-auto relative overflow-hidden transform-gpu"
          >
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center relative z-10">
              ...
              <div className="text-[11.5px] leading-tight font-medium text-[var(--text-primary)] whitespace-normal break-words">

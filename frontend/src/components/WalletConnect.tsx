    ...
    return (
        <div className="w-full h-full">
            <motion.div
                ...
                className="glass-panel p-1 h-full rounded-2xl border-emerald-500/10 bg-brand-surface flex items-center justify-between relative shadow-premium overflow-visible"
            >

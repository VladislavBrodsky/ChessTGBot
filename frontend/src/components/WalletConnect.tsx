            ...
            <div className="w-full min-w-0">
                {wallet ? (
                    <button
                        ...
                        className="w-full min-h-[44px] px-3 rounded-xl bg-brand-primary hover:opacity-90 text-brand-void text-[10px] font-black uppercase tracking-widest active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-md"

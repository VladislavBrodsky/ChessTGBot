...
def create_application() -> FastAPI:
    ...
    # API Routers
    from app.api.v1.endpoints import game, users, webhook, gamification, wallet, admin, arena, telemetry, cross_chain
    ...
    application.include_router(cross_chain.router, prefix="/api/v1/wallet", tags=["wallet"])
